...
class NCF(L.LightningModule):
    ...
    def __init__(self):
        super().__init__()
        self.user_fc_1 = nn.Linear(in_features=4, out_features=128)
        self.item_fc_1 = nn.Linear(in_features=54, out_features=128)
        self.user_fc_2 = nn.Linear(in_features=128, out_features=64)
        self.item_fc_2 = nn.Linear(in_features=128, out_features=64)
        self.bilinear = nn.Bilinear(in1_features=128, in2_features=128, out_features=128)
    ...
    def training_step(self, batch: Any, batch_idx: int) -> STEP_OUTPUT:
        user_input, item_input, labels, user_ids = batch
